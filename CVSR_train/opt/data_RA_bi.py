...
class CDVL_sideInfo_Dataset(Dataset):
    ...
    def __init__(self, csv_file, transform=None, QP=32, only_I_frame=True, random_start=False,
                 ...
                 LR_dir_prefix="/share3/home/zqiang/CVCP/Decoded_LR/RA/",
                 SideInfo_dir_prefix="/share3/home/zqiang/CVCP/Coding_Priors/RA/"):
        ...
        # self.LR_dir_prefix = LR_dir_prefix + self.QP + '/Rec_'
        # self.LR_dir_postfix = '_480x270_32F.yuv/'

        # self.SideInfo_dir_prefix = SideInfo_dir_prefix + self.QP + '/'
        # self.SideInfo_dir_postFix = "_480x272_32F/"

        self.LR_dir_prefix = LR_dir_prefix + 'QP' + self.QP + '/RA_'
        self.LR_dir_postfix = '_32F_' +  'QP' + self.QP + '.yuv/'  #  '_480x270_32F_' + 

        self.SideInfo_dir_prefix = SideInfo_dir_prefix + 'QP' + self.QP + '/RA_'
        self.SideInfo_dir_prefix22 = "/share3/home/zqiang/CVCP/Coding_Priors/LD/" + 'QP' + '22' + '/LD_'
        self.SideInfo_dir_prefix_unfiltered = "/share3/home/zqiang/CVCP/pred_unfiltered_RA/" + 'QP' + self.QP + '/RA_'
        self.SideInfo_dir_postFix =  '_32F_' + 'QP' + self.QP + ".priors/"  #  "_480x272_32F_" +
        self.SideInfo_dir_postFix22 =  '_32F_' + 'QP' + '22' + ".priors/" 
        ...
        self.MVl1s_ = np.zeros([len(self.data_path_details), 32, 270, 480, 3], dtype = np.int8)
        ...
        for d_i in range(len(self.data_path_details)):
            ...
            side_paths22 = self.SideInfo_dir_prefix22 + seq_name + self.SideInfo_dir_postFix22
            ...
            for f_i in range(32):
                ...
                ####
                mvl1_tmp = np.clip(np.load(mvl1_name), -128, 127).astype(np.int8)
                self.MVl1s_[d_i, f_i, :, :, :] = mvl1_tmp
                ####
                ...
                # else:
                #     img_idx_DSF = img_idx
                # mpm_name = side_paths22 + 'DSF_Map/' + img_idx_DSF + '.png'
                ...
                # unflt_f_name = side_paths + 'unfiltered/' + img_idx + '_unflt.png'
                unflt_f_name = side_paths_forunfiltered + 'pred_unfilered/' + img_idx + '_unflt.png'
    ...
    def __getitem__(self, idx):
        ...
        if self.only_1_GT: 
            ...
            # hr_img = np.load(self.dir_all[idx][center_idx][1], mmap_mode='r')
        ...
        if self.mv_flag:
            ...
            if self.only_1_GT:
                ...
                mvl1 = self.MVl1s_[idx, center_idx, :, :, :]
                mvl1s.append(mvl1)
            else:
                print("??")
                exit(0)
...
class Augment(object):
    def __call__(self, sample, hflip=True, rot=True):
        ...
        if mvl0s is not None:
            ...
            MV0_u_m = np.where(mvl0s[0,:,:,2] == -99)

            mvl0s_7[2, :, :, 0] = np.where(~np.isnan(pre_f_x), pre_f_x, 0)
            mvl0s_7[2, :, :, 1] = np.where(~np.isnan(pre_f_y), pre_f_y, 0)

            #### frame 4
            pre_f_x_MV1 = mvl1s[0,:,:,0] / mvl1s[0,:,:,2] 
            pre_f_y_MV1 = mvl1s[0,:,:,1] / mvl1s[0,:,:,2]
            MV1_u_m = np.where(mvl1s[0,:,:,2] == -99)
