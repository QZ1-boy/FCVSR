...
def generate_flow(dir_path):
    ...
    parser.add_argument('--model', default='/home/zhuqiang/FMA-Net-main/preprocessing/pretrained/raft-sintel.pth', help="restore checkpoint")
...
if __name__ == '__main__':
    ...
    generate_flow('/home/zhuqiang/FMA-Net-main/dataset/REDS4/train_sharp_bicubic/X4')
    generate_flow('/home/zhuqiang/FMA-Net-main/dataset/REDS4/val_sharp_bicubic/X4')