...
You can also obtain these testing datasets from our Baiduyun [test datas](https://auguste7.github.io/CVCP-database/). But training low-resolution compressed videos should be re-generated by released codec. 
