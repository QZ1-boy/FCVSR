...
import numpy as np
import argparse
from arch.CVSR_freq_S import GShiftNet  # SIDECVSR
...
def eval_seq(tst_list, gt_list, methods_name = "J", coding_cfg = "LD", testing=True, cal_metric=True):
    if testing:
        ...
        model_path = '/share3/home/zqiang/CVSR_train/training_results/train_LD_freqCVSR_S_37/ckpt/epoch-13400.pth'  # 10000 18000  16400
