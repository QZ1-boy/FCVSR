...
import numpy as np
import argparse
from arch.OtherMethod_arch import BasicVSRPlusPlus
...
def eval_seq(tst_list, gt_list, coding_cfg = "LD", testing=True):
    if testing:
        ...
        model_path = '/share3/home/zqiang/mmediting0406/mmediting-master/work_dirs/basicvsr_plusplus_cvcp_LD_QP22/iter_104000.pth' 
        ...
        for img_set, one_gt in zip(tst_list, gt_list):
            ...
            for _, _, f in os.walk(tmp_path):
                ...
                for i in range(len(f)):
                    ...
                    print(i,'...', end="\r")
                FPS = len(f) / Sumtime 
                print('BasicVSRPP at', one_gt, 'FPS:', FPS)
                f1 = open("./FPS/log_BasicVSRPP_FPS.txt", 'a+')
