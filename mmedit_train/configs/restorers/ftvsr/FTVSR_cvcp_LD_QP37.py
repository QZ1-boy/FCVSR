...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            gt_folder='/share3/home/zqiang/CVCP/Uncompressed_HR_LD/QP37',
...
load_from = None
resume_from = None # f'/share3/home/zqiang/mmediting0406/mmediting-master/work_dirs/ftvsr_cvcp_LD_QP37/iter_290000.pth'
workflow = [('train', 1)]
