...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            gt_folder='/share3/home/zqiang/CVCP/Uncompressed_HR_LD/QP32',
...
load_from = None
resume_from = f'/share3/home/zqiang/mmediting0406/mmediting-master/work_dirs/ftvsr_cvcp_LD_QP32/iter_140000.pth'
workflow = [('train', 1)]
