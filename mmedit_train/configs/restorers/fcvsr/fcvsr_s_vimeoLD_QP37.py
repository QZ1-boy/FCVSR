exp_name = 'fcvsr_s_vimeo_LD_QP37'
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            lq_folder='/share3/home/zqiang/Vimeo90K/sequences_CompressedFrame/QP37',
    ...
    val=dict(
        ...
        lq_folder='/share3/home/zqiang/Vimeo90K/Vid4/BI_VC_CompressedFrame/QP37',
...
load_from = '/share3/home/zqiang/mmediting0406/mmediting-master/work_dirs/fcvsr_s_vimeo_LD_QP37/iter_300000.pth'
resume_from = None
workflow = [('train', 1)]
