...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            lq_folder='/share3/home/zqiang/REDS/train_sharp_VC_BI_CompressedFrame/QP37',
    ...
    val=dict(
        ...
        lq_folder='/share3/home/zqiang/REDS/REDS4/REDS4_VC_BI_CompressedFrame/QP37',
...
load_from = '/share3/home/zqiang/mmediting0406/mmediting-master/work_dirs/fcvsr_s_reds_LD_QP37/iter_560000.pth'
resume_from = None
workflow = [('train', 1)]
