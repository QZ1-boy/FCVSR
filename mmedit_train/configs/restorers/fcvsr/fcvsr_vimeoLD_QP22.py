...
model = dict(
    ...
    generator=dict(
        type='FCVSRNet'),
    pixel_loss=dict(type='CharbonnierLoss', loss_weight=1.0, reduction='mean'))  #  MSELoss  CharbonnierLoss
...
data = dict(
    workers_per_gpu=6,
    train_dataloader=dict(samples_per_gpu=12, drop_last=True),  # 2 gpus
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            lq_folder='/share3/home/zqiang/Vimeo90K/sequences_CompressedFrame/QP22',
    ...
    val=dict(
        ...
        lq_folder='/share3/home/zqiang/Vimeo90K/Vid4/BI_VC_CompressedFrame/QP22',
...
load_from = None  # '/share3/home/zqiang/mmediting0406/mmediting-master/work_dirs/fcvsr_vimeo_LD_QP22/iter_190000_bk.pth'
resume_from = None
workflow = [('train', 1)]
