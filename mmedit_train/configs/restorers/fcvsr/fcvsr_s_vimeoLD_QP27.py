exp_name = 'fcvsr_s_vimeo_LD_QP27'
...
model = dict(
    ...
    generator=dict(
        type='FCVSR_SNet'),
    pixel_loss=dict(type='CharbonnierLoss', loss_weight=5.0, reduction='mean'))
...
load_from = None # '/share3/home/zqiang/mmediting0406/mmediting-master/work_dirs/fcvsr_s_vimeo_LD_QP27/iter_590000.pth'
resume_from = None
workflow = [('train', 1)]
