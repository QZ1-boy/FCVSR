exp_name = 'basicvsr_cvcp_LD_QP22'
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            gt_folder='/share3/home/zqiang/CVCP/Uncompressed_HR_LD/QP22',  #  CVCP_anna.txt
    ...
    test=dict(
        ...
        # lq_folder='/share3/home/zqiang/mmediting0406/mmediting-master/CVCP_test/test_data1/LD/qp22',
        # gt_folder='/share3/home/zqiang/mmediting0406/mmediting-master/CVCP_test/test_data1/gt_Y',
        # ann_file='CVCP_test/test_data1/meta_info_CVCP_test_1.txt',
...
load_from = None
resume_from = './work_dirs/basicvsr_cvcp_LD_QP22/iter_30000.pth'
workflow = [('train', 1)]
