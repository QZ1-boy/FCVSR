exp_name = 'fcvsr_reds_LD_QP22'

# model settings
model = dict(
    type='BasicVSR',
    generator=dict(type='FCVSRNet'),
    pixel_loss=dict(type='MSELoss', loss_weight=1.0, reduction='mean'))
# model training and testing settings
train_cfg = dict(fix_iter=100)
test_cfg = dict(metrics=['PSNR', 'SSIM', 'tOF'], crop_border=0, convert_to='Y')

# dataset settings
train_dataset_type = 'SRREDSMultipleGTDataset'  # 'SRREDSDataset' # 
val_dataset_type = 'SRVid4Dataset' # SRREDSMultipleGTDataset SRVid4Dataset 'SRREDSDataset'  # 'SRVid4Dataset_org' # 'SRREDSDataset'  SRVid4Dataset_org
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            lq_folder='/share3/home/zqiang/REDS/train_sharp_VC_BI_CompressedFrame/QP22',
    ...
    val=dict(
        ...
        lq_folder='/share3/home/zqiang/REDS/REDS4/REDS4_VC_BI_CompressedFrame/QP22',
...
# learning policy  MultiStepLR
total_iters = 600000
lr_config = dict(
    policy='CosineRestart', # MultiStepLR
    by_epoch=False,
...
# load_from = '/share3/home/zqiang/mmediting0406/mmediting-master/work_dirs/fcvsr_vimeo_LD_QP22/iter_600000.pth'
load_from = '/share3/home/zqiang/mmediting0406/mmediting-master/work_dirs/fcvsr_reds_LD_QP22/iter_53000.pth'
resume_from = None
workflow = [('train', 1)]
