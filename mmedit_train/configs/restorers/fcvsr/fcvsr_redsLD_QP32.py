...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            lq_folder='/share3/home/zqiang/REDS/train_sharp_VC_BI_CompressedFrame/QP32',
    ...
    val=dict(
        ...
        lq_folder='/share3/home/zqiang/REDS/REDS4/REDS4_VC_BI_CompressedFrame/QP32',
...
load_from = '/share3/home/zqiang/mmediting0406/mmediting-master/work_dirs/fcvsr_vimeo_LD_QP32/iter_475000.pth'
resume_from = None
workflow = [('train', 1)]
