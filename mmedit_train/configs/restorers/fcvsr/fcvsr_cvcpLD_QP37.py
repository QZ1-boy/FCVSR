exp_name = 'basicvsr_cvcp_LD_QP37'
...
val_pipeline = [
    ...
    dict(  type='LoadImageFromFileList', io_backend='disk', key='lq', channel_order='rgb'),   #  rgb
    dict(  type='LoadImageFromFileList',  io_backend='disk', key='gt',  channel_order='rgb'),
    dict(type='RescaleToZeroOne', keys=['lq', 'gt']),
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            lq_folder='/share3/home/zqiang/CVCP/Decoded_LR/LD/QP37',
            gt_folder='/share3/home/zqiang/CVCP/Uncompressed_HR_LD/QP37',  #  CVCP_anna.txt
            ann_file='CVCP_test/test_data/CVCP_anna_GT_LD_QP37.txt',
            num_input_frames=32,
    ...
    val=dict(
        ...
        lq_folder='/share3/home/zqiang/mmediting0406/mmediting-master/CVCP_test/test_data1/LD/qp37',
    ...
    test=dict(
        type=val_dataset_type,
        lq_folder='/share3/home/zqiang/mmediting0406/mmediting-master/CVCP_test/test_data/LD/qp37/lr_grey',
