...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            lq_folder='/share3/home/zqiang/Vimeo90K/sequences_CompressedFrame/QP27',
    ...
    val=dict(
        ...
        lq_folder='/share3/home/zqiang/Vimeo90K/Vid4/BI_VC_CompressedFrame/QP27',
...
load_from = None # '/share3/home/zqiang/mmediting0406/mmediting-master/work_dirs/fcvsr_vimeo_LD_QP27/iter_40000.pth'
resume_from = None
workflow = [('train', 1)]
