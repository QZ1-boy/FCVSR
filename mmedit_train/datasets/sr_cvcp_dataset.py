...
class SRCVCPDataset(BaseSRDataset):
    """CVCP dataset for video super resolution.
    ...
    It reads CVCP keys from the txt file.
    Each line contains:
    ...
    ::
        ...
        000/000000.png (720, 1280, 3)
        000/000001.png (720, 1280, 3)
        ...
        for key in keys:
            data_infos.append(
                dict(
                    ...
                    key=key,
                    max_frame_num=32,  # CVCP has 32 frames for each clip
