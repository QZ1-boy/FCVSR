...
from .test import multi_gpu_test, single_gpu_test, multi_gpu_test_time, single_gpu_test_time
...
__all__ = [
    ...
    'restoration_inference', 'multi_gpu_test_time', 'single_gpu_test_time',
