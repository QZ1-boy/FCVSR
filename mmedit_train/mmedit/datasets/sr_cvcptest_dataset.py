...
class SRCVCPtestDataset(BaseSRDataset):
    """CVCPtest dataset for video super resolution.
    ...
    It reads CVCPtest keys from the txt file.
    Each line contains:
    ...
    Args:
        ...
        filename_tmpl (str): Template for each filename. Note that the
            template excludes the file extension. Default: '{:05d}'.
    ...
    def load_annotations(self):
        """Load annoations for CVCPtest dataset.
        Returns:
