...
from mmedit.core import psnr, ssim, tOF, tensor2img
...
class BasicRestorer(BaseModel):
    ...
    """
    allowed_metrics = {'PSNR': psnr, 'SSIM': ssim, 'tOF': tOF}
    ...
    def forward_train(self, lq, gt):
        ...
        b, t, c, h, w = gt.shape
        gt = gt[:, t//2, :,:,:]
        # print('out',output.shape, gt.shape)
    ...
    def forward_test(self,
        ...
        """
        # output = self.generator(lq)
        print('[forward_test output gt ]',output.shape, gt.shape )
