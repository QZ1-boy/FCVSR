...
def main(): 
    QP_list = [22,27] #  ,27,32,37
    # CKP_list = ['./work_dirs/fcvsr_reds_LD_QP22/iter_30000.pth','./work_dirs/fcvsr_reds_LD_QP27/iter_600000.pth','./work_dirs/fcvsr_reds_LD_QP32/iter_475000.pth','./work_dirs/fcvsr_reds_LD_QP37/iter_600000.pth']
    # CKP_list = ['./work_dirs/fcvsr_reds_LD_QP32/iter_470000.pth','./work_dirs/fcvsr_reds_LD_QP37/iter_475000.pth']
    CKP_list = ['./work_dirs/fcvsr_reds_LD_QP22/iter_51000.pth','./work_dirs/fcvsr_reds_LD_QP27/iter_55000.pth']

    for QP, CKP in zip(QP_list, CKP_list):
        args = parse_args()
        config_path = './configs/restorers/fcvsr/fcvsr_redsLD_QP' + str(QP) + '.py'
        ...
        args.save_path = './save_out/REDS4/FCVSR/'+'LD_QP' + str(QP)
        ...
        log_file = "/share3/home/zqiang/mmediting0406/mmediting-master/save_out/REDS4_test_log/FCVSR_LD_QP%s.txt" % (QP)
        ...
        for one_t, one_gt in zip(res_vid_name, gt_vid_name):           
            ...
            psnr, ssim, tOF = cal_psnr_ssim_tOF_RGB(
                    './save_out/REDS4/FCVSR/LD_QP%s/' % (QP),
                    [one_t],
                    [one_gt],
